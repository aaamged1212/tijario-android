...
object LocalizedErrorMapper {
    private val codeToKey = mapOf(
        ...
        "template_not_allowed" to "doc_error_template_not_allowed",
        "ai_limit_reached" to "ai_limit_reached",
        "context_not_found" to "ai_error_context_not_found",
        "missing_ai_config" to "ai_error_not_configured",
        "provider_failed" to "ai_error_provider_unavailable",
        "provider_timeout" to "ai_error_provider_timeout",
        "generation_pending" to "ai_error_provider_unavailable",
        "invalid_context_snapshot" to "ai_error_invalid_context_snapshot",
        "invalid_fields" to "ai_error_invalid_fields",
        "network_offline" to "ai_error_network",
        "network_unavailable" to "ai_error_network",
        "retryable_timeout" to "ai_error_provider_unavailable",
    ...
    private val messagePatterns = linkedMapOf(
        ...
        "context not found" to "ai_error_context_not_found",
        "missing ai config" to "ai_error_not_configured",
        "provider failed" to "ai_error_provider_unavailable",
        "provider timeout" to "ai_error_provider_timeout",
        "invalid context snapshot" to "ai_error_invalid_context_snapshot",
        "generation pending" to "ai_error_provider_unavailable",
        "invalid fields" to "ai_error_invalid_fields",
