...
data class AdminAnalyticsOverviewDto(
    ...
    @SerialName("daily_active_devices") val dailyActiveDevices: Int = 0,
    @SerialName("daily_active_users") val dailyActiveUsers: Int = 0,
    @SerialName("onboarding_completed") val onboardingCompleted: Int = 0,
    @SerialName("total_foreground_seconds") val totalForegroundSeconds: Int = 0,
    @SerialName("average_session_duration_seconds") val averageSessionDurationSeconds: Int = 0,
    @SerialName("median_session_duration_seconds") val medianSessionDurationSeconds: Int = 0,
    @SerialName("local_invoices_created") val localInvoicesCreated: Int = 0,
    @SerialName("local_quotes_created") val localQuotesCreated: Int = 0,
    @SerialName("pdf_previews") val pdfPreviews: Int = 0,
    @SerialName("share_clicks") val shareClicks: Int = 0,
    @SerialName("whatsapp_share_clicks") val whatsappShareClicks: Int = 0,
    @SerialName("ai_reply_successes") val aiReplySuccesses: Int = 0,
    @SerialName("ai_caption_successes") val aiCaptionSuccesses: Int = 0,
    @SerialName("client_errors") val clientErrors: Int = 0,
    @SerialName("upgrade_screen_opens") val upgradeScreenOpens: Int = 0,
    @SerialName("plan_limit_reached") val planLimitReached: Int = 0,
